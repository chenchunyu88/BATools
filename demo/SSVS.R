...
init=set.init(~driploss,data=PigPheno,geno=geno,~id,df=5,pi_snp=0.001,h2=0.5,c=1000,model="SSVS",centered=TRUE)
...
op<-set.options(model="SSVS",method="MCMC",seed=1,priors=NULL,init=init,
