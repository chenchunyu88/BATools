...
init=set.init(~driploss,data=PigPheno,geno=geno,~id,df=5,pi_snp=1,h2=0.5,c=NULL,model="anteBayesA",centered=TRUE)
...
op<-set.options(model="anteBayesA",method="MCMC",priors=NULL,init=init,
